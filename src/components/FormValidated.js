...
function FormValidated({ onContinue, className }) {
    ...
    return <div className={`flex flex-col pt-32 px-10 bg-white items-center lg:pl-[30%] lg:pr-[10%] ${className}`}>
        <img className="w-[100px] lg:mt-36" src={succesfull} alt="complete" />
