...
function Input({ onChange, className, label, errormessage, ...rest }) {
    ...
    return <div className={`${rest.name === "cardExpiryMounth" || rest.name === "cardExpiryYear" || rest.name === "cardCvc" ? "flex flex-col justify-end lg:w-[100px] xl:w-[120px] 2xl:w-[150px]" : "w-full"}`}>
